...
..
_leveldb-snapshots: LevelDB Snapshotting ....................
...
A single Ether Cattle cluster provides several operational benefits over running conventional Ethereum nodes, but the master server is still a single point of failure.
